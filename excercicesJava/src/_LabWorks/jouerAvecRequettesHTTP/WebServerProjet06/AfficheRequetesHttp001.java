...
public class AfficheRequetesHttp001 {
	public static void main(String[] args) throws IOException {
		ServerSocket s = new ServerSocket(8035);
		while (true) {
			Socket c = s.accept();
			// on recupere
			...
			String racine = "C:/Users/KADRI/eclipse-workspace/Requete_Http/src/";
			String chemin = "";
					...
					try {
						...
						*/
					    ...
					    out.writeBytes("Content-Type: text/html\r\n\r\n"); // informe le navigateur qu'il s'agit d'un 
					                                                      // d'un fichier Html
						    /* out.writeBytes("<html><head></head><body><h1>Not found !</h1></body></html>");
                            */
					    out.writeBytes(test);

package _LabWorks.jouerAvecRequettesHTTP.WebServerProjet04;
...
public class AfficheRequetesHttp_2 {

	public static void main(String[] args) {

		if (args.length != 2) {
			System.err.println("Usage: java " + AfficheRequetesHttp_2.class.getName() + "portnumber directory");
			System.exit(1);
		}
